cask 'forticlient-offline' do
  version '6.4.6'
  sha256 'f3b486d87fa565cf03fb87b00a4dccf110fe50b99401b95c585fc87a880923d8'

  url 'https://files.exolnet.com/forticlient/FortiClientVPNSetup_6.4.6.1378_macosx.dmg'
  name 'FortiClient'
